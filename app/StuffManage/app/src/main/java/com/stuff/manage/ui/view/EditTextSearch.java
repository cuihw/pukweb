package com.stuff.manage.ui.view;
...
public class EditTextSearch extends AppCompatEditText {
    private static final String TAG = "EditTextSearch";
    /**
     ...
     */
    private void init() {
        clearDrawable = getResources().getDrawable(R.drawable.ic_menu_close_clear_cancel);
        searchDrawable = getResources().getDrawable(R.drawable.ic_search_category_default);
